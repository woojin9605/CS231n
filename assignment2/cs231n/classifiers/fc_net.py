...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        grads['W2'] = dw2 + self.reg * self.params['W2'] # 0.5 * 2 = 1
        grads['b2'] = db2
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for i in range(self.num_layers-1):
            ...
            x, cache = affine_norm_relu_drop_forward(x,w,b, gamma, beta, bn_params, self.normalization,
        ...
        for i in range(self.num_layers-2,-1,-1):
            dx,dw,db,dgamma,dbeta = affine_norm_relu_drop_backward(dout, caches[i],
...
def affine_norm_relu_drop_forward(x, w, b, gamma,beta, bn_param,normalization, dropout, drop_param):
...
def affine_norm_relu_drop_backward(dout, cache, normalization, dropout):
    ...
    dx, dw, db = affine_backward(dout,aff_cache)
